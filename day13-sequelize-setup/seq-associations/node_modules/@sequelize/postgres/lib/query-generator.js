...
class PostgresQueryGenerator extends import_query_generator_typescript_internal.PostgresQueryGeneratorTypeScript {
  ...
  attributeToSQL(attribute, options) {
    ...
    let type;
    const arraySubtype = attribute.type instanceof import_core.DataTypes.ARRAY ? attribute.type.options.type : null;
    if (attribute.type instanceof import_core.DataTypes.ENUM || attribute.type instanceof import_core.DataTypes.ARRAY && arraySubtype instanceof import_core.DataTypes.ENUM) {
